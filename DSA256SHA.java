...
public class DSA256SHA {

    public static void main(String[] args) throws Exception {
        // Sample message
        String message = "APJAbdulKalam";

        int keyLength = 2048; // Larger key size
        System.out.println("Original Message: " + message);
        
        // Calculate SHA-256 hash of the original message
        byte[] sha256Hash = calculateSHA256(message);
        System.out.println("SHA-256 Hash of the Message: " + bytesToHex(sha256Hash));
        ...
        System.out.println("\nStep 3: Passing the message, digital signature, and public key to the Verifier");
    ...
    public static byte[] calculateSHA256(String message) throws Exception {
    ...
    public static byte[] createDigitalSignature(String message, PrivateKey privateKey) throws Exception {
        Signature dsa = Signature.getInstance("SHA256withDSA"); // SHA-256
